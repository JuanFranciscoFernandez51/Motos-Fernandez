...
const styles = StyleSheet.create({
  ...
  tableRow: { flexDirection: "row", borderBottom: "1px solid #EFEFEF", paddingVertical: 3 },
  tableHeader: { flexDirection: "row", backgroundColor: "#F8F5FA", paddingVertical: 4, paddingHorizontal: 2, fontWeight: 700 },
