...
export const BUSINESS = {
  ...
  slogan: "+40 anos de confianza sobre dos ruedas",
  description: "Concesionaria multimarca de motocicletas, cuatriciclos, UTVs y motos de agua en Bahia Blanca. Mas de 40 anos de experiencia, financiacion propia y servicio tecnico.",
  address: "Brown 1052, Bahia Blanca, Buenos Aires",
  city: "Bahia Blanca",
...
export const WHATSAPP_MESSAGES = {
  ...
  modelo: (nombre: string) =>
    `Hola! Estoy interesado en el modelo ${nombre}. Me pasan info y disponibilidad?`,
