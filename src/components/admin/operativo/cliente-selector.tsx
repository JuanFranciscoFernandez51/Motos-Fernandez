          ...
          {filtered.length === 0 ? (
            <div className="p-4 text-center">
              ...
              <Link
                ...
                target="_blank"
                className="mt-2 inline-flex items-center gap-1 text-xs text-[#6B4F7A] hover:underline"
              >
                <Plus className="size-3" /> Crear cliente nuevo
              </Link>
            </div>
          ) : (
            <>
              ...
              <Link
                href="/admin/clientes/nuevo"
                target="_blank"
                className="flex items-center gap-2 px-3 py-2 bg-gray-50 text-[#6B4F7A] hover:bg-[#6B4F7A]/5 text-sm"
              >
