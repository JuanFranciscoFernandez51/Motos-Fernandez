        ...
        <div className="p-5 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              autoFocus
              disabled={isPending}
              className="mt-2 w-full rounded-md border border-gray-200 px-3 py-2 text-sm focus:border-red-500 focus:outline-none focus:ring-2 focus:ring-red-500/20 disabled:opacity-50"
            />
            {error && (
