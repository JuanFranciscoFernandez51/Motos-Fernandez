    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-3 flex-wrap">
        ...
        <div className="flex items-center gap-2">
          <a href={`/api/admin/finanzas/export?tipo=anual&anio=${anio}`} className="rounded-lg border border-gray-300 dark:border-neutral-700 px-3 py-1.5 text-xs hover:bg-gray-50 dark:hover:bg-neutral-800">Excel del año</a>
