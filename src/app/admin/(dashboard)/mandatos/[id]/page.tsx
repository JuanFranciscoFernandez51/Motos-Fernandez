...
export default async function EditarMandatoPage({
  ...
  const initialData = {
    ...
    tieneTarjetaVerde: mandato.tieneTarjetaVerde,
    tienePrenda: mandato.tienePrenda,
    detallePrenda: mandato.detallePrenda || "",
    // Compatibilidad: si todavía hay mandatos viejos con verificacionTecnica
    // pero sin tieneVTV, lo usamos como fallback
    tieneVTV: mandato.tieneVTV || mandato.verificacionTecnica,
    tieneManual: mandato.tieneManual,
    tieneSegundaLlave: mandato.tieneSegundaLlave,
